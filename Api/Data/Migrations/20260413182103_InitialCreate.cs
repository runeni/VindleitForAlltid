        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WindFromDirection = table.Column<double>(type: "double precision", nullable: false),
                    SymbolCode = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ForecastEntries_Spots_SpotId",
                        column: x => x.SpotId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForecastEntries_SpotId_Time",
                table: "ForecastEntries",
                columns: new[] { "SpotId", "Time" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Spots_Identifier",
                table: "Spots",
                column: "Identifier",
                unique: true);
        }
