...
| `good`       | ≥ 7 and < 12 m/s | "good"      | green          |
| `strong`     | ≥ 12 and < 18 m/s | "strong"   | yellow         |
| `dangerous`  | ≥ 18 m/s        | "dangerous"  | red            |

The `WindLevel` type SHALL include `'very-light'` as a valid variant alongside `'none'`, `'light'`, `'good'`, `'strong'`, and `'dangerous'`.
